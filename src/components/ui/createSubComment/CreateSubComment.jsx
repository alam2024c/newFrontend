...
export default function CreateSubComment({
  ...
  const [return_metion, setreturn_metion] = useState(dataComment?.return || "");
  const [mention, setMention] = useState(dataComment?.mention || []);
  ...
  return (
    <div ref={menuComent} className="w-100">
      ...
      <form
        ...
        className="flex w-full w-100 comments"
      >
