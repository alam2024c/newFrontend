...
import { getDataPostArticle, getDataPostSummeries } from "../../components/posts/getDataPost";

export default function Summeries({ data }) {
  ...
  const { items, hasMore, loadMore } = getDataPostSummeries(
    1,
    token,
    deletePost_id,
    update,
