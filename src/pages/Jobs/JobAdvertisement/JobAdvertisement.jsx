...
import AddJobAdvertisement from "./AddJobAdvertisement/AddJobAdvertisement";
...
function JobAdvertisement() {
  ...
  const { token, deletePost_id, updateJobAdvertisement } = useSelector(
    (state) => state.auth
  );
  ...
  const { items, hasMore, loadMore } = getDataPostJobAdvertisement(
    1,
    token,
    deletePost_id,
                ...
                >
                  ...
                  >
                    <div className="add ">
                      ...
                      <h3 className="sm:px-14">{post?.company}</h3>
                      <p
                        className="sm:px-14"
                        style={{
                          color: "#7C8493",
                      ...
                      <div className="singlePost py-4 d-flex align-items-end flex-wrap gap-3">
                        ...
                        <button
                          ...
                          onClick={() => {
                            navigate(`/advertisement/${post.id}`);
                          }}
                        >
                          {t("Details")}
                        </button>
